...
/** @typedef {*} RequestData The data of an request */

/** @typedef {Object<string,*>} Headers The headers of an request or response*/

/** @typedef {Object<string,*>} EndpointParameters A key value to replace variables in an API path */
