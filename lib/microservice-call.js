...
class MicroServiceCall {
	 ...
	 */
	async list(service, namespace, filters = null) {
	 ...
	 * @returns {Object} Returns the response, in the body the full list of objects
	 */
	async safeList(service, namespace, filters = null) {
		...
		do {
			response = await this.safeCall(service, namespace, 'list', filters, { 'x-janis-page': page });
