...
module.exports = class MicroServiceCall {
	 ...
	 */
	async list(service, namespace, requestData = null, endpointParameters) {
		...
		do {
			response = await this.call(service, namespace, 'list', requestData, { 'x-janis-page': page }, endpointParameters);
	 ...
	 * @returns {Object} Returns the response, in the body the full list of objects
	 */
	async safeList(service, namespace, requestData = null, endpointParameters) {
		...
		do {
			response = await this.safeCall(service, namespace, 'list', requestData, { 'x-janis-page': page }, endpointParameters);
