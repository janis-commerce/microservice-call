...
class MicroServiceCall {
	...
	async list(service, namespace, filters = null, endpointParameters = null) {
		...
		do {
			response = await this.call(service, namespace, 'list', filters, { 'x-janis-page': page }, endpointParameters);
	...
	async safeList(service, namespace, filters = null, endpointParameters = null) {
		...
		do {
			response = await this.safeCall(service, namespace, 'list', filters, { 'x-janis-page': page }, endpointParameters);
	...
	/**
	 * Get the message from a MicroSerivceCall Response
